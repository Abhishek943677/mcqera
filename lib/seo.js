...
export default function Seo() {
  return (
    <>
      <DefaultSeo
        useAppDir={true}
        title="Mcqera | Online lessons | MCQs | Notes"
        ...
        additionalMetaTags={[
          {
            name: "keywords",
            content: `MCQs,Government exam MCQs,SSC MCQs,Railway exams MCQs,General knowledge MCQs for government exams,Exam preparation MCQs,Practice tests for government exams,Previous year question papers for government exams,Study material for government exams,Competitive exams MCQs,Exam-specific syllabus MCQs,Study materials for government exams,Important topics for government exams,handwritten notes,IGNOU solved assignments,previous year exam papers,download exam papers, exam preparation, practice papers,Education,Courses,Study materials`
          },
        ]}
        openGraph={{
          type: "website",
          locale: "en_IE",
          url: "https://mcqera.com/",
          siteName: "mcqera",
          images: [
            {
