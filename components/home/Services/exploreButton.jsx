...
const ExploreButton = () => {
  return (
    <button className="group flex items-center justify-center p-2 gap-2 border-none rounded-lg cursor-pointer bg-gradient-to-r from-[#412b5f] to-[#60339a] transition-transform duration-1000">
      <span className="flex flex-col items-center justify-center w-6 h-6">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 156 78"
          className="w-full h-auto transform rotate-[-20deg] transition-transform duration-1000 group-hover:rotate-[-50deg]"
        >
          <path
      ...
      <span className="text-gray-200 font-medium text-lg tracking-wide">Explore</span>
    </button>
  );
};
